...
lazy_static! {
    ...
    pub static ref GAMEPLAY_ATLAS: atlas_img::Atlas = {
        let path = CONFIG
            ...
            .unwrap()
            .celeste_root
            .join("Content/Graphics/Atlases/Gameplay.meta");
    ...
    pub static ref FG_TILES: HashMap<char, autotiler::Tileset> = {
        let path = CONFIG
            ...
            .unwrap()
            .celeste_root
            .join("Content/Graphics/ForegroundTiles.xml");
    ...
    pub static ref BG_TILES: HashMap<char, autotiler::Tileset> = {
        let path = CONFIG
            ...
            .unwrap()
            .celeste_root
            .join("Content/Graphics/BackgroundTiles.xml");
    ...
    pub static ref SPRITE_CACHE: Mutex<Vec<HashMap<SpriteReference, ImageBuffer>>> =
        Mutex::new(Vec::new());
            ...
            EMBEDDED_CONFIG
                ...
                .map(|f| {
                    let config: EntityConfig =
                        serde_yaml::from_str(f.contents_utf8().unwrap()).unwrap();
